...
$result3 = mysql_query( "SELECT value FROM `tblpaymentgateways` WHERE gateway='webmoneyeur' and setting='webmoneyeurkey'" );
$webmoneyeurkey = mysql_fetch_array( $result3 );
$my_crc = strtoupper( hash ('sha256', $_POST['LMI_PAYEE_PURSE'].$_POST['LMI_PAYMENT_AMOUNT'].$_POST['LMI_PAYMENT_NO'].$_POST['LMI_MODE'].$_POST['LMI_SYS_INVS_NO'].$_POST['LMI_SYS_TRANS_NO'].$_POST['LMI_SYS_TRANS_DATE'].$webmoneyeurkey['0'].$_POST['LMI_PAYER_PURSE'].$_POST['LMI_PAYER_WM']) );
...
$rate = mysql_query( "SELECT value FROM `tblpaymentgateways` WHERE gateway='webmoneyeur' and setting='webmoneyeurrate'" );
