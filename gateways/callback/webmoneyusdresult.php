...
{
    logtransaction( "WebMoney Z", "Amount not correct! invoice=".$data['total']." currency_invoice=".$total_invoice." itogo=$itogo ".$debugreport, "Error" );
    echo "NO";
    exit();
}


addinvoicepayment( $data['id'], $_POST['LMI_PAYMENT_NO'], "", "", "webmoneyusd" );
logtransaction( "WebMoney Z", $debugreport, "Successful" );
echo "OK\n";
?>
